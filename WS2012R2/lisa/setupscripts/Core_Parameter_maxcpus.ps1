...
<#
.Synopsis
    Verify CPU can be offline permanently by boot with maxcpus=xx
.Description
    This script will verify CPU can be offline permanently by boot with maxcpus=xx
.Parameter vmName
    Name of the test VM.
.Parameter hvServer
